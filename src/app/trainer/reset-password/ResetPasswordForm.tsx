  ...
  if (isValidToken === null) {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-700 text-center">
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-700">
        ...
        <div className="mt-6 text-center text-sm text-gray-400">
          ...
          <Link href="/login" className="font-medium text-[#22b664] hover:text-[#1da058] transition-colors">
            Sign in
          </Link>
        </div>
      </div>
