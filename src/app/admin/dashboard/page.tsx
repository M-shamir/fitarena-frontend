...
import TrainerRevenueOverview from '@/app/components/admin/TrainerRevenueOverview';
import StadiumOwnerRevenueOverview from '@/app/components/admin/StadiumRevenueOverview';
                ...
                <div className="ml-6 mt-1 space-y-1">
                  ...
                  >
                    ...
                    Approved Courses
                     ...
                     <button
                    onClick={() => setActivePage('trainerRevenue')}
                    className={`flex items-center px-4 py-2 text-sm rounded-lg w-full ${
                      activePage === 'trainerRevenue' 
                        ? 'bg-[#1a8d4d] text-white' 
                        : 'text-gray-300 hover:bg-gray-700'
                    }`}
                  >
            ...
            <div className="relative">
              ...
              {stadiumDropdownOpen && (
                <div className="ml-6 mt-1 space-y-1">
                  ...
                  <button
                    onClick={() => setActivePage('StadiumOwnerRevenueOverview')}
                    className={`flex items-center px-4 py-2 text-sm rounded-lg w-full ${
                      activePage === 'StadiumOwnerRevenueOverview' 
                        ? 'bg-[#1a8d4d] text-white' 
                        : 'text-gray-300 hover:bg-gray-700'
                    }`}
                  >
          ...
          <div className="px-6 py-4 flex justify-between items-center">
            <h2 className="text-xl font-semibold text-white">
              {activePage === 'dashboard' ? 'Dashboard' : 
               ...
               activePage === 'trainerRevenue' ? 'Trainer Revenue Overview' :
               activePage === 'StadiumOwnerRevenueOverview' ? 'Stadium Revenue Overview' : ''}
            </h2>
        ...
        {/* Main Content */}
         <div className="p-6 bg-gray-900 min-h-screen">
          {activePage === 'dashboard' ? (
            ...
            <TrainerRevenueOverview/>
          ) : activePage === 'StadiumOwnerRevenueOverview' ? (
            <StadiumOwnerRevenueOverview/>
          ) : null}
        </div>
      </div>
    </div>
