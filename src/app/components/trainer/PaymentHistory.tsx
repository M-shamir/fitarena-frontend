              ...
              {payments.length > 0 ? (
                payments.map((payment) => (
                  <tr key={payment.id} className="hover:bg-gray-700/30 transition duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-white">{payment.course_title}</div>
                      <div className="text-sm text-gray-400">ID: {payment.course_id}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-white">{payment.student_email}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
