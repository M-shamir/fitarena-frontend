              ...
              <div key={booking.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-5">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-medium text-gray-800 dark:text-white">{booking.stadium}</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-300">{booking.sport}</p>
        ...
        <div className="space-y-4">
          {bookings.past.length > 0 ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1">You haven't completed any stadium bookings yet</p>
            </div>
          )}
        </div>
      )}
...
export default StadiumBookings