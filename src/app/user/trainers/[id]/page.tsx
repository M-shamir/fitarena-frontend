        ...
        <div className="p-6">
          ...
          <div className="space-y-3 mb-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Max Participants</p>
                <p className="text-gray-600 dark:text-gray-300 text-sm">{course.max_participants}</p>
              </div>
            </div>
          ...
          >
            {course.status === "approved" ? "Enroll Now" : "Not Available"}
